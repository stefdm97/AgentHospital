...
a(avvisa_medico):-a(message(medico,send_message(arriva_paziente(3,2),var_Me))).

eve(visita_paziente):-write('Il paziente 3 si fa visitare...'),a(message(medico,send_message(termina_visita(3),var_Me))).

eve(visita_finita):-write('Il paziente 3 ha terminato la visita').
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_311797,var_Ontology,_311801),_311791),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_311835)),a(message(var_Ag,propose(var_A,[_311835],var_AgI))),retractall(ext_agent(var_Ag,_311873,var_Ontology,_311877)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_311671,var_Ontology,_311675),_311665),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_311741,var_Ontology,_311745)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_311559,var_Ontology,_311563),_311553),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_311615,var_Ontology,_311619)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_311123),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_311157),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_310939).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_310787),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_310735),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_310611,_310613)),clause(agente(_310633,_310635,_310637,var_S),_310629),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_310405,_310407,_310409,var_S),_310401),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_310505,[]),repeat,read(_310505,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_310505).
