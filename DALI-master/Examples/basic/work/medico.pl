...
eve(arriva_paziente(var_Id,var_Priorita)):-write('Paziente arrivato'),now(var_Timestamp),assert(ticket_paziente(var_Id,var_Priorita,var_Timestamp)).
...
eve(termina_visita(var_Id)):-number_chars(var_Id,var_App),atom_chars(var_IdString,var_App),atom_concat('paziente',var_IdString,var_AgentName),format('Il paziente ~d e stato visitato.',var_Id),nl,a(message(var_AgentName,send_message(visita_finita,var_Me))),retract(ticket_paziente(var_Id,var__,var__)),a(libera_stanza).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_350425,var_Ontology,_350429),_350419),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_350463)),a(message(var_Ag,propose(var_A,[_350463],var_AgI))),retractall(ext_agent(var_Ag,_350501,var_Ontology,_350505)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_350299,var_Ontology,_350303),_350293),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_350369,var_Ontology,_350373)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_350187,var_Ontology,_350191),_350181),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_350243,var_Ontology,_350247)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_349751),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_349785),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_349567).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_349415),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_349363),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_349239,_349241)),clause(agente(_349261,_349263,_349265,var_S),_349257),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_349033,_349035,_349037,var_S),_349029),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_349133,[]),repeat,read(_349133,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_349133).
